      ...
      <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-6 rt-single-widget">
          <a href="#" class="footer-logo">
            <img src="frontend/assets/images/logo/logowhite.png" alt />
          </a>
          <address>
        ...
        <div class="col-lg-2 col-md-3 col-sm-6 rt-single-widget">
          ...
          <ul class="rt-usefulllinks2">
            ...
            <li><a href="login.html">Candidate Dashboard</a></li>
            <li><a href="login.html">Saved Jobs</a></li>
          </ul>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 rt-single-widget">
          <h2 class="footer-title">Employers</h2>
          <ul class="rt-usefulllinks2">
            <li><a href="login.html">Post a Job</a></li>
            <li><a href="employers.html">Browse Employers</a></li>
            <li><a href="login.html">Employers Dashboard</a></li>
            <li><a href="login.html">Applications</a></li>
          </ul>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 rt-single-widget">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 text-center text-lg-start f-size-14 text-gray-500">
          &copy; Jobpilot 2023 | All Rights Reserved
        </div>
        <div class="col-lg-6 text-center text-lg-end">
          <ul class="footer-social-links">
            <li>
              <a href="https://www.facebook.com/zakirsoft">
            ...
            <li>
              <a href="https://www.instagram.com/zakirsoft">
                <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip3)">
                    <path
                      ...
                      fill="#767E94"
                    />
                    <path class="facebook" d="M8.00635 13.0077L13.2122 10.0093L8.00635 7.01099V13.0077Z" fill="white" />
                  </g>
                  <defs>
                    <clippath id="clip02">
            ...
            <li>
              <a href="https://www.youtube.com/zakirsoft">
                <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a href="https://www.twitter.com/zakirsoft">
                <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
