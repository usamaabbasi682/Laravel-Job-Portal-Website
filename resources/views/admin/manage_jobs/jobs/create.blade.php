...
<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
   ...
   <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
      ...
      <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
         ...
         <!--end::Item-->
         <!--begin::Item-->
         <li class="breadcrumb-item text-gray-500">Add Job</li>
         <!--end::Item-->
      </ul>
      <!--end::Breadcrumb-->
   </div>
                  ...
                  <div class="row border">
                    <div class="col-md-12 p-4">
                        ...
                        <div class="fv-row mb-7">
                           ...
                           <!--end::Label-->
                           <!--begin::Input-->
                           <input type="text" class="form-control form-control-solid" name="title" placeholder="Enter Title" value="{{ old('title') }}" />
                           @error('title')
                     ...
                     <div class="col-md-6 p-4">
                        ...
                        <div class="fv-row mb-7">
                           ...
                           <select name="company" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Company" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($company->id == old('company')) value="{{ $company->id ?? '' }}">{{ ucwords($company->company_name) ?? '' }}</option>
                              @empty @endforelse
                           </select>
                           @error('company')
                           <span class="text-danger">
                     ...
                     <div class="col-md-6 p-4">
                        ...
                        <div class="fv-row mb-7">
                           ...
                           <select name="category" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Category" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($category->id == old('category')) value="{{ $category->id ?? '' }}">{{ ucwords($category->name) ?? '' }}</option>
                              @empty @endforelse
                           </select>
                           @error('category')
                           <span class="text-danger">
                     ...
                     <div class="col-md-6 p-4">
                        ...
                        <div class="fv-row mb-7">
                           ...
                           <!--end::Label-->
                           <!--begin::Input-->
                           <input type="text" class="form-control form-control-solid" name="vacancies" placeholder="Enter Vacancies" value="{{ old('vacancies') }}" />
                           @error('vacancies')
                           <span class="text-danger">
                              <strong>{{ $message }}</strong>
                           </span>
                     ...
                     <div class="col-md-6 p-4">
                        ...
                        <div class="fv-row mb-7">
                           ...
                           <!--end::Label-->
                           <!--begin::Input-->
                           <input type="date" class="form-control form-control-solid" name="deadline" placeholder="Enter Deadline" value="{{ old('deadline') }}" />
                           @error('deadline')
                           <span class="text-danger">
                              <strong>{{ $message }}</strong>
                           </span>
                        ...
                        <div class="col-md-12">
                           <div class="fv-row mb-7">
                              ...
                              @endphp
                                 ...
                                 <option data-kt-flag="flags/united-states.svg" @selected($st == old('salary_type')) value="{{ $st }}">{{ ucwords($st) ?? '' }}</option>
                                 @endforeach
                              </select>
                              @error('salary_type')
                              <span class="text-danger">
                  ...
                  <div class="row mt-5 border p-4">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="form-group">
                         ...
                         <div class="radio-inline mt-8">
                             <label class="radio radio-square">
                                 <input type="radio" id="featured" class="form-check-input" value="featured" name="jobfeature">
                                 <span></span>
                                 Featured
                             </label>
                             <label class="radio radio-square" style="padding-left: 20px;">
                                 <input type="radio" id="highlight" class="form-check-input" value="highlight" name="jobfeature">
                                 <span></span>
                                 Highlight
                             </label>
                         </div>
                  ...
                  <div class="row mt-5 border p-4">
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select name="experience" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Experience" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($experience == old('experience')) value="{{ $experience }}">{{ ucwords($experience) ?? '' }}</option>
                              @empty @endforelse
                           </select>
                           <!--end::Select-->
                           @error('experience')
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select name="job_role" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Role" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($jobRole->id == old('job_role')) value="{{ $jobRole->id }}">{{ ucwords($jobRole->name) ?? '' }}</option>
                              @endforeach
                           </select>
                           <!--end::Select-->
                           @error('job_role')
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select name="education" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Education" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($education == old('education')) value="{{ $education }}">{{ ucwords($education) ?? '' }}</option>
                              @empty @endforelse
                           </select>
                           <!--end::Select-->
                           @error('education')
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select multiple name="tags[]" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Tags" class="form-select form-select-solid">
                              <option value=""></option>
                              @forelse ($tags as $tag)
                              <option data-kt-flag="flags/united-states.svg" value="{{ $tag->id }}">{{ ucwords($tag->name) ?? '' }}</option>
                              @empty
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select multiple name="benefit[]" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Benefit" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" value="{{ $benefit->id }}">{{ ucwords($benefit->name) ?? '' }}</option>
                              @empty
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select name="job_type" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Job Type" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($jobType == old('job_type')) value="{{ $jobType }}">{{ ucwords($jobType) ?? '' }}</option>
                              @empty
                     ...
                     <div class="col-md-12">
                        <div class="mb-10">
                           ...
                           <!--end::Label-->
                           <!--begin::Select-->
                           <textarea name="bio" id="description" rows="10" cols="80">{{ old('description') }}</textarea>
                           <!--end::Select-->
                        </div>
                     </div>
                  </div>
