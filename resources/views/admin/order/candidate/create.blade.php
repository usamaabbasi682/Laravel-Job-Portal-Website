                     ...
                     <div class="col-md-12 border p-4">
                        ...
                        <div class="fv-row mb-7">
                           ...
                           <select name="candidate" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Candidate" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($candidate->id == old('candidate')) value="{{ $candidate->id ?? '' }}">{{ ucwords($candidate->name) ?? '' }}</option>
                              @empty @endforelse
                           </select>
                           @error('candidate')
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select name="profession" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select currency" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($profession == old('profession')) value="{{ $profession }}">{{ ucwords($profession) ?? '' }}</option>
                              @empty @endforelse
                           </select>
                           <!--end::Select-->
                           @error('profession')
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select name="job_role" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Role" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($jobRole == old('job_role')) value="{{ $jobRole }}">{{ ucwords($jobRole) ?? '' }}</option>
                              @endforeach
                           </select>
                           <!--end::Select-->
                           @error('job_role')
                     ...
                     <div class="col-md-4">
                        <div class="mb-10">
                           ...
                           <select name="gender" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Gender" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($gender == old('gender')) value="{{ $gender }}">{{ ucwords($gender) ?? '' }}</option>
                              @empty @endforelse
                           </select>
                           <!--end::Select-->
                           @error('gender')
                     ...
                     <div class="col-md-6">
                        <div class="mb-10">
                           ...
                           <select name="marital_status" aria-label="Select a Timezone" data-control="select2" data-placeholder="Marital Status" class="form-select form-select-solid">
                              ...
                              <option data-kt-flag="flags/united-states.svg" @selected($m_status == old('marital_status')) value="{{ $m_status }}">{{ ucwords($m_status) ?? '' }}</option>
                              @empty @endforelse
                           </select>
