...
<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
  ...
  <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
    ...
    <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
      ...
      <!--end::Item-->
      <!--begin::Item-->
      <li class="breadcrumb-item text-gray-500">Candidates</li>
      <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
  </div>
    ...
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
          ...
          <!--end::Svg Icon-->
          <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Candidate" />
        </div>
        <!--end::Search-->
      </div>
      <!--begin::Card title-->
      ...
      <div class="card-toolbar">
        ...
        <a href="{{ route('admin.candidate.create') }}" class="btn btn-primary">
      ...
      <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        <thead>
          ...
          <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
            ...
            <th class="min-w-215px">Candidate</th>
            <th class="min-w-115px">Role/Position</th>
            <th class="min-w-115px">Applied Jobs</th>
        ...
        <tbody class="text-gray-600 fw-semibold">
            ...
            <tr>
                ...
                <td><span class="badge badge-light-primary fw-bold">{{ Str::ucfirst($candidate->job_role) ?? '' }}</span></td>
                <td>{{ $cdandidate->applied_jobs ?? '0' }} Applied Jobs</td>
                <td>@datetime($candidate->created_at)</td>
                <td>
                    @if ($candidate->user->account_status)
                ...
                <td class="text-end">
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                    <div class="menu-item px-3">
                      <a href="{{ route('admin.candidate.edit',$candidate) }}" class="menu-link form-control px-3">Edit</a>
                    </div>
                    <div class="menu-item px-3">
