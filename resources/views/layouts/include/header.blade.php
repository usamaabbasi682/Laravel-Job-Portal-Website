                ...
                <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                    ...
                    <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_header_navs_wrapper', lg: '#kt_brand_tabs'}">
                        ...
                        <ul class="nav flex-nowrap text-nowrap">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/dashboard') ? 'active' : '' }}" href="{{ route('admin.home') }}">Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a 
                                class="nav-link @if(request()->is('admin/users') || request()->is('admin/orders') || request()->is('admin/candidate') || request()->is('admin/company')) {{ __('active') }} @else {{ __('') }} @endif" 
                                href="{{ route('admin.users.index') }}">Order</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(request()->is('admin/jobs') || request()->is('admin/jobCategory') || request()->is('admin/jobRole') || request()->is('admin/jobPlan')) {{ __('active') }} @endif" href="{{ route('admin.jobs.index') }}">Manage Jobs</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="d-lg-flex container-xxl w-100">
            ...
            <div class="d-lg-flex flex-column justify-content-lg-center w-100" id="kt_header_navs_wrapper">
                ...
                <div class="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}" data-kt-scroll-height="auto" data-kt-scroll-offset="70px">
                    <!--begin::Tab panel-->
                    @if(request()->is('admin/users') || request()->is('admin/orders') || request()->is('admin/candidate') || request()->is('admin/company')) 
                            ...
                            <div class="header-menu flex-column align-items-stretch flex-lg-row">
                                ...
                                <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
                                    ...
                                    <div class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                                        <!--begin:Menu link-->
                                        <a href="{{ route('admin.users.index') }}" class="menu-link py-3 {{ request()->is('admin/users')?'active':'' }}">
                                    ...
                                    <div class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                                        <!--begin:Menu link-->
                                        <a href="{{ route('admin.orders.index') }}" class="menu-link py-3 {{ request()->is('admin/orders')?'active':'' }}">
                                    ...
                                    <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                        <!--begin:Menu link-->
                                        <a href="{{ route('admin.company.index') }}" class="menu-link py-3 {{ request()->is('admin/company')?'active':'' }}">
                                    ...
                                    <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                        <!--begin:Menu link-->
                                        <a href="{{ route('admin.candidate.index') }}" class="menu-link py-3 {{ request()->is('admin/candidate')?'active':'' }}">
                    ...
                    <!--end::Tab panel-->
                    <!--begin::Tab panel-->
                    @if(request()->is('admin/jobs') || request()->is('admin/jobCategory') || request()->is('admin/jobRole') || request()->is('admin/jobPlan'))
                    <div class="tab-pane fade active show">
                        <!--begin::Menu wrapper-->
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            <!--begin::Menu-->
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
                                ...
                                <div class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('admin.jobs.index') }}" class="menu-link py-3 {{ request()->is('admin/jobs')?'active':'' }}">
                                ...
                                <div class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('admin.jobCategory.index') }}" class="menu-link py-3 {{ request()->is('admin/jobCategory')?'active':'' }}">
                                ...
                                <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('admin.jobRole.index') }}" class="menu-link py-3 {{ request()->is('admin/jobRole')?'active':'' }}">
                                ...
                                <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('admin.jobPlan.index') }}" class="menu-link py-3 {{ request()->is('admin/jobPlan')?'active':'' }}">
                                        <span class="menu-title">Job Plan</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                                <!--begin:Menu item-->
                                <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2"  id="kt_header_navs_tab_3">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('admin.tags.index') }}" class="menu-link py-3 {{ request()->is('admin/tags')?'active':'' }}">
                    ...
                    @if (request()->is('admin/tags') || request()->is('admin/benefits'))
                    <div class="tab-pane fade active show">
                        <!--begin::Menu wrapper-->
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            <!--begin::Menu-->
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
                                ...
                                <div class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('admin.tags.index') }}" class="menu-link py-3 {{ request()->is('admin/tags')?'active':'' }}">
                                        <span class="menu-title">Tage</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                                ...
                                <div class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('admin.benefits.index') }}" class="menu-link py-3 {{ request()->is('admin/benefits')?'active':'' }}">
